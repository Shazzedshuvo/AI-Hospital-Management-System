...
const BentoGrid = ({
  ...
  <div
    className={`grid w-full auto-rows-[22rem] grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ${className}`}
  >
    {children}
  </div>
);

// ---- Fixed BentoGridItem Component ----
const BentoGridItem = ({
  title,
  description,
  header,
...
const features = [
  ...
  },
  {
    ...
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/031/610/125/small_2x/a-young-male-doctor-clicking-on-an-image-while-other-medical-icons-are-displayed-medical-stock-images-ai-generative-photo.jpg",
    icon: <FiCalendar />,
    href: "/doctors",
  },
  {
    ...
    description:
      "Ask symptoms, get instant answers using AI-powered medical assistant.",
    image:
      "https://img.freepik.com/premium-photo/ai-powered-electronic-health-assistants-solid-color-background_964851-7839.jpg",
    icon: <FiCpu />,
    href: "/ai-assistant",
  },
  {
    ...
    image:
      "https://tse3.mm.bing.net/th/id/OIP.UctyyeQoqN9QQyzpzM250gHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",
    icon: <FiActivity />,
    href: "/diagnostics",
    className: "md:col-span-2",
  },
  {
    ...
    image:
      "https://static.vecteezy.com/system/resources/previews/021/529/558/non_2x/emergency-medical-services-concept-doctor-holding-in-hand-the-emergency-symbol-online-medical-support-first-aid-medicine-and-healthcare-application-illustration-vector.jpg",
    icon: <FiAlertCircle />,
    href: "/emergency",
  },
  {
    ...
    image:
      "https://wallpaperbat.com/img/9730796-how-artificial-intelligence-is.jpg",
    icon: <FiPackage />,
    href: "/medicines",
  },
];
    ...
    <section className="px-4 py-16 sm:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-xl text-gray-600 mb-16 max-w-3xl mx-auto">
          Explore the core features designed to simplify your medical journey
